# ==================================================
# 🚀 KRISHN - ENHANCED PDF PROCESSING & SEARCH SYSTEM
# Production-ready backend for custom domain
# ==================================================
...
class EnhancedPDFProcessor:
    ...
    def process_uploaded_pdfs(self, pdf_files):
        """Process uploaded PDF files for backend API"""
    ...
    def enhanced_smart_chunking(self, text: str, page_num: int, source_file: str, chunk_size: int = 400, overlap: int = 50) -> List[Dict]:
        ...
        for i, chunk in enumerate(chunks):
            ...
            if i > 0 and len(chunks[i-1]['text']) > overlap:
                ...
                if len(combined_text) <= chunk_size * 1.5:
